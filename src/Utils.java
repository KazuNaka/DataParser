...
public class Utils {
    ...
    private static void removecomma(String[] datalines, int i) {
        int index1 = datalines[i].indexOf("\"");
        int index2 = datalines[i].indexOf("\"", index1 + 1);
